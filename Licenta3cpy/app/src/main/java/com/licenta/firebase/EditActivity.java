...
//import static com.example.gocztiti.petfriends.PetType.Petss;
import static com.licenta.firebase.PetTypes.Petss;
public class EditActivity extends AppCompatActivity {
    ...
    public void onClickSaveApButton(View view) {
        ...
        Pets app = new Pets(tt, at);

        Petss.set(position, app);
        finish();
    }
