...
public class PetTypes extends AppCompatActivity {
    ...
    public static ArrayList<Pets> Petss =new ArrayList<Pets>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        descriptionTxt = (EditText) findViewById(R.id.descriptionInput);


        adapter = new ArrayAdapter<>(PetTypes.this, android.R.layout.simple_list_item_1, Petss);
        //Pets.add(a);
        //Pets.add(b);
        ...
        show.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position,
                                    long id) {
                Pets a = (Pets) parent.getItemAtPosition(position);

                String[] b = {a.getName(),a.getMinidesc()};

                Intent intent = new Intent(PetTypes.this, EditActivity.class);
                String message = "abc";
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Pets r = new Pets(getName, getDescription);
                boolean exists=Petss.contains(r);
                if (exists) {
                    ...
                    Petss.add(r);
                    ArrayAdapter<Pets> adapter = new ArrayAdapter<Pets>(PetTypes.this, android.R.layout.simple_list_item_1, Petss);
                    show.setAdapter(adapter);
    ...
    public void updateFragment(){
        adapter =new ArrayAdapter<Pets>(this.getBaseContext(),android.R.layout.simple_expandable_list_item_1, Petss);
    ...
    public static void createFile( Context ctx) throws IOException, JSONException {
        ...
        for (int i = 0; i < Petss.size(); i++) {
            ap = new JSONObject();
            ap.put("Name", Petss.get(i).getName());
            ap.put("Desc", Petss.get(i).getMinidesc());
